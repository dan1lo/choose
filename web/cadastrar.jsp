<%-- 
    Document   : login
    Created on : 09/07/2012, 22:40:28
    Author     : saturnino
--%>
...
<div id="container">
    ...
    <div id="central">
	 ...
	 <div id="conteudo" >  
          ...
          <img  id="porsch" width="300px" height="300px" src="imagens/porsche.jpg" alt="Mini logo"/> 
          
           <jsp:include page="login.jsp" /> 
           <jsp:include page="cadastro.jsp" />     
        </div><div id="frase">Será que o seu carro é <br/>o mais bonito?</div>
	<div id="sombra"></div> 
   </div>
     
	<div id="footer">
		<img  id="mini_logo" src="imagens/mini_logo.png" alt="Mini logo"/>
	</div>
	<div id="rodape">
            © ChooseCar 2012
	</div>
